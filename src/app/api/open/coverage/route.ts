...
import { getProductStrategySnapshot } from '@/lib/product-strategy'
...
export async function GET(request: Request) {
  ...
  const productStrategy = getProductStrategySnapshot()
  ...
  const body = JSON.stringify({
    ...
    productPositioning: productStrategy.productPositioning,
    buyerPersonas: productStrategy.buyerPersonas,
    businessModel: productStrategy.businessModel,
    architectureLoop: productStrategy.architectureLoop,
    pseoAutomationLoop: productStrategy.pseoAutomationLoop,
    optimizationCycles: productStrategy.optimizationCycles,
