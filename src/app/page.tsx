      ...
      <section className="px-4 pb-20 sm:px-6 lg:px-8">
        <div className="mx-auto grid max-w-7xl gap-10 overflow-hidden rounded-[2.5rem] bg-[#14202c] px-8 py-10 text-white lg:grid-cols-[0.95fr_1.05fr] lg:px-12 lg:py-14">
          <div className="space-y-5">
            <p className="text-[11px] font-semibold uppercase tracking-[0.28em] text-emerald-200">Wait Updates</p>
            <h2 className="font-[var(--font-display)] text-4xl font-black tracking-tight text-balance text-white">Save the task and wait with context.</h2>
            <p className="max-w-xl text-base leading-8 text-slate-300">
              Use this when timing is the blocker. Bes3 will keep the shortlist, category, or offer path warm and only email when the next move is worth reopening.
            </p>
          </div>
