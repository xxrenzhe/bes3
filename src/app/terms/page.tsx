...
export default function TermsPage() {
  const summaryCards = [
    {
      label: 'What Bes3 is',
      title: 'A buyer guidance product',
      description: 'Bes3 publishes informational buying guidance, shortlist flows, reviews, comparisons, and affiliate-linked merchant exits to help readers make cleaner purchase decisions.'
    },
    {
      label: 'What Bes3 is not',
      title: 'Not the final merchant authority',
      description: 'Pricing, stock status, shipping, and merchant policies can change without notice, so the final checkout source remains the merchant itself.'
    },
    {
      label: 'Affiliate model',
      title: 'Commission can exist without changing the route',
      description: 'Bes3 may earn commissions from qualifying purchases, but the product promise is still buyer-first routing, honest reasons to skip, and category-fit before click-through.'
    }
  ]

  const buyerRules = [
    'Treat Bes3 as decision guidance, not as a replacement for final merchant terms or checkout confirmation.',
    'Use price as a last-stage buying signal, since the public site is designed to narrow fit before it accelerates a purchase.',
    'Assume the merchant remains authoritative for current price, availability, shipping, warranties, and returns.'
  ]
  ...
  const routeCards = [
    ...
    {
      title: 'Contact Bes3',
      description: 'Use contact if you have a terms question, correction request, or concern about a public route.',
      href: '/contact',
      label: 'Open Contact'
    }
  ]
      ...
      <div className="mx-auto max-w-7xl space-y-14 px-4 py-16 sm:px-6 lg:px-8">
          ...
          <div className="grid gap-8 xl:grid-cols-[1fr_0.95fr] xl:items-start">
            <div>
              ...
              <p className="mt-4 max-w-3xl text-lg leading-8 text-muted-foreground">
                Last updated April 4, 2026. These terms explain how to use Bes3, what the site promises, and where merchant responsibility begins once a reader leaves the public guide and enters a checkout flow.
              </p>
              <div className="mt-6 rounded-[1.75rem] bg-slate-950 p-5 text-white">
                ...
                <p className="mt-3 text-sm leading-7 text-slate-200">
                  Bes3 is an informational buying-guide product with affiliate links. We aim to make the decision clearer, but the final merchant remains authoritative for live pricing, stock, and transaction terms.
                </p>
              </div>
            </div>
        ...
        <section className="grid gap-8 lg:grid-cols-[1.02fr_0.98fr]">
          <div className="rounded-[2.5rem] bg-white p-8 shadow-panel sm:p-10">
            <SectionHeader
              ...
              description="These are the practical limits of the product. The site should reduce research noise and clarify tradeoffs, but it should not be mistaken for the merchant, the warranty issuer, or the checkout system."
            />
          ...
          <div className="rounded-[2.5rem] bg-white p-8 shadow-panel sm:p-10">
            ...
            <p className="mt-4 text-sm leading-8 text-muted-foreground">
              Readers usually open terms to validate trust, affiliate incentives, or merchant responsibility. Once that question is answered, the next move should return them to the right Bes3 flow.
            </p>
        ...
        <article className="rounded-[2.5rem] bg-white p-8 shadow-panel sm:p-10">
          <div className="editorial-prose">
            ...
            <p>
              Bes3 provides informational buying guidance and affiliate links. Product pricing, stock, and merchant terms can change without notice.
            </p>
            <h3>Content use</h3>
            <ul>
            ...
            <h3>Merchant responsibility</h3>
            <p>
              Once a user clicks through to a merchant, that merchant controls the final transaction terms, including pricing, availability, shipping, returns, and service commitments.
            </p>
            <h3>Questions</h3>
            <p>
              If you need clarification about these terms or want to flag a problem with a public route, use the <Link href="/contact">contact page</Link>.
            </p>
          </div>
        </article>
      </div>
