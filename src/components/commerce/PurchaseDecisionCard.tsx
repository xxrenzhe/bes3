...
const STATE_STYLES: Record<PurchaseDecision['state'], { card: string; badge: string; accent: string }> = {
  buy_now: {
    ...
    >
      ...
      <div className="mt-6">
        {isPrimaryMerchant ? (
          ...
          <div className="inline-flex min-h-[52px] items-center justify-center rounded-full bg-white/80 px-6 py-3 text-sm font-semibold text-muted-foreground">
            {decision.primaryActionLabel}
          </div>
        )}
