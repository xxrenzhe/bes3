...
const DEFAULT_SETTINGS = [
  ...
  ['affiliateSync', 'amazonPageSize', process.env.PARTNERBOOST_AMAZON_PAGE_SIZE || '20', 'number', 0, 'PartnerBoost Amazon products fetched per page'],
  ['affiliateSync', 'dtcPageSize', process.env.PARTNERBOOST_DTC_PAGE_SIZE || '20', 'number', 0, 'PartnerBoost DTC products fetched per page'],
  ['affiliateSync', 'maxPagesPerSync', process.env.PARTNERBOOST_MAX_PAGES_PER_SYNC || '5', 'number', 0, 'Maximum PartnerBoost pages fetched in one admin sync'],
