...
async function runBrowserChecks(plan13Routes: Plan13TestRoutes) {
  ...
  try {
    ...
    await assertText(page, 'Know what to buy, compare, wait on, or skip.', 'Plan13 home purchase task routes')
    await assertText(page, 'Commission neutral', 'Plan13 home purchase task routes')
