...
Generated at: generated by npm run db:generate-baseline
...
| `asin` | `TEXT` | no | `` | no |
| `brand` | `TEXT` | no | `` | no |
| `product_model` | `TEXT` | no | `` | no |
| `model_number` | `TEXT` | no | `` | no |
| `product_type` | `TEXT` | no | `` | no |
| `category` | `TEXT` | no | `` | no |
...
| `youtube_match_terms_json` | `TEXT` | no | `` | no |
...
| `attempt_count` | `INTEGER` | yes | `0` | no |
| `max_attempts` | `INTEGER` | yes | `2` | no |
| `proxy_country` | `TEXT` | no | `` | no |
| `proxy_used` | `TEXT` | no | `` | no |
| `browser_engine` | `TEXT` | no | `` | no |
| `http_status` | `INTEGER` | no | `` | no |
| `request_headers_json` | `TEXT` | no | `` | no |
| `redirect_chain_json` | `TEXT` | no | `` | no |
| `browser_signals_json` | `TEXT` | no | `` | no |
| `result_json` | `TEXT` | no | `` | no |
| `error_message` | `TEXT` | no | `` | no |
| `started_at` | `TEXT` | no | `` | no |
| `completed_at` | `TEXT` | no | `` | no |
| `created_at` | `TEXT` | yes | `CURRENT_TIMESTAMP` | no |
| `updated_at` | `TEXT` | yes | `CURRENT_TIMESTAMP` | no |
